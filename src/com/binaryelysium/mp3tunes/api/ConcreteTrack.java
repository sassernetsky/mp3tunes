...
public class ConcreteTrack implements Track
{
    ...
    public ConcreteTrack(Id id, String play_url, String download_url, String title,
    ...
    public ConcreteTrack(Id id, String playUrl, String downloadUrl, String title, int number,
    ...
    public boolean sameRemoteFile(Track t)
    {
        ...
        if (t.getFileKey() == null || t.getFileKey().equals("")) {
            if (t.getPlayUrl(0) == null || t.getPlayUrl(0).equals("")) {
                return false;
            }
